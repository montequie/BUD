...
fixed_position_dict = {}
for motor_name in motor_turn_names:
...
def set_config(config_name='config'):
    ...
    play_Follow_44_key = {'key': '2',
                          ...
                          'args': 'Follow_44'}
    play_Farewell_New_key = {'key': '3',
                             'module': 'experiment',
                             'function': '_play_animation',
                             'help': 'play animation - Farewell_New',
                             'args': 'Farewell_new'}
    play_Welcome_starting_pose_key = {'key': '4',
                                      'module': 'experiment',
                                      'function': '_play_animation',
                                      'help': 'play animation - Welcome_starting_pose',
                                      'args': 'Welcome_starting_pose'}
    play_Nod_44_key = {'key': '5',
                  'module': 'experiment',
                  'function': '_play_animation',
                  'help': 'play animation - Nod_44',
                  'args': 'Nod_44'}
    play_startPosetoTurn_key = {'key': '6',
                   'module': 'experiment',
                   'function': '_play_animation',
                   'help': 'play animation - startPosetoTurn',
                   'args': 'startPosetoTurn'}
    torque_key = {'key': 't',
                  'module': 'experiment',
    ...
    bud_game_key = {'key': 'g',
                    ...
                    'help': 'set positions to 0 and start playing the bud word game',
                    'args': motor_turn_names
                    }
    config['SHORTCUTS'] = [play_Follow_44_key, play_Welcome_New_key, play_Farewell_New_key,
                           play_Welcome_starting_pose_key, play_startPosetoTurn_key, play_Nod_44_key,
                           torque_key, fix_positions_key, bud_game_key]
...
# fixed_position_dict = {}
# for motor_name in motor_turn_names:
#     fixed_position_dict[motor_name] = {GOAL_ACCELERATION_REGISTER: 2,
#                                        MOVING_SPEED_REGISTER: 50,
#                                        GOAL_POSITION_REGISTER: 2048,
#                                        }
#
#
